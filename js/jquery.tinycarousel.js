...
(function($)
{
    ...
    function Plugin($container, options)
    {
        ...
        this.move = function(index)
        {
            ...
            $('.overview li').removeClass('active-img');
            $('.overview li').eq(slideIndex).addClass('active-img');
            //console.log(self.slideCurrent);

            contentStyle[posiLabel] = (-slideIndex+2) * slideSize;
